...
public class FTPDownloadInstance {
    /**
     * ftp连接
     */
     ...
     * 下载txt文件，返回文件路径
     */
    public  String Download_txt(String txt_name) {
...
//            ftpClient.changeWorkingDirectory(new String("ifremer/argo/dac".getBytes("UTF-8"),"ISO-8859-1"));
     ...
     * 下载nc文件，返回文件路径
     */
    public  ArrayList<String> Download_list(ArrayList<String> urls) {
...
//                ftpClient.setSoTimeout(20000);
     ...
     * @throws IOException
     */
    public  boolean ExcuteDownLoad(FTPFile file) throws IOException {
        boolean res = false;
        String filename = "";
        String ftpFilePath = "";
        try {
...
//            DBInteraction(filename, "downloading");
     ...
     * @throws IOException
     */
    public  boolean DataDownLoad(String filename, File localFile, String FullURL, long localSize,
